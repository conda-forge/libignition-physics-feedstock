...
Once the `conda-forge` channel has been enabled, `libignition-physics5` can be installed with:

```
conda install libignition-physics5
```

It is possible to list all of the versions of `libignition-physics5` available on your platform with:
